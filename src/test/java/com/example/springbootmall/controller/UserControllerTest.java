...
public class UserControllerTest {
    ...
    @Test
    public void test_register_invalidEmailFormat() throws Exception {
        UserRegisterRequest userRegisterRequest = new UserRegisterRequest();
    ...
    @Test
    public void test_register_emailAlreadyExist() throws Exception {
        // 先註冊一個帳號
        UserRegisterRequest userRegisterRequest = new UserRegisterRequest();
    ...
    public void test_login_success() throws Exception {
        ...
        userRegisterRequest.setPassword("123");
        test_register(userRegisterRequest);
    ...
    @Test
    public void test_login_wrongPassword() throws Exception {
        // 先註冊新帳號
        UserRegisterRequest userRegisterRequest = new UserRegisterRequest();
    ...
    @Test
    public void test_login_invalidEmailFormat() throws Exception {
        UserLoginRequest userLoginRequest = new UserLoginRequest();
    ...
    @Test
    public void test_login_emailNotExist() throws Exception {
        UserLoginRequest userLoginRequest = new UserLoginRequest();
